...
const formValidationSchema = z.object({
	...
	about: z.string({ required_error: 'about is required' }).max(300, { message: "About can't exceed 300 characters" }),
})
		...
		<>
			<div className="w-[600px] mx-auto mt-[52px]">
				<article className="space-y-[4px]">
					...
					<p className="text-[15px]">This information will be displayed publicly.</p>
				</article>
				<Form {...form}>
					<form action="" className="mt-[46px] space-y-[12px]" onSubmit={form.handleSubmit(onSubmit)}>
						<FormField
						...
						<FormField
							...
							render={({ field }) => (
								<FormItem>
									...
									<FormDescription>Write a few sentence about yourself.</FormDescription>
									<FormMessage />
								</FormItem>
							)}
						/>
						<Button className="bg-blue-500 hover:bg-blue-500/90 block">Connect with Calendar</Button>
