...
export namespace $default {
  export interface Calendar extends std.$Object {
    "gmail": string;
    "accessToken": string;
  ...
  export interface Course extends std.$Object {
    "code": string;
    "description": string;
    "label": string;
  }
  export interface Osteopath extends std.$Object {
    "username": string;
    "student"?: Student | null;
    "bio"?: string | null;
    "friday"?: unknown | null;
    "monday"?: unknown | null;
    "saturday"?: unknown | null;
    "sunday"?: unknown | null;
    "thursday"?: unknown | null;
    "tuesday"?: unknown | null;
    "verification_by"?: string | null;
    "wednesday"?: unknown | null;
    "user"?: User | null;
  }
  export type Role = "admin" | "user" | "osteopath";
  export interface Session extends std.$Object {
    "user": User;
    "expiresAt": Date;
  }
  export interface Student extends std.$Object {
    "course": Course;
    "email": string;
    "batch"?: string | null;
...
import Calendar = $default.Calendar;
import Course = $default.Course;
import Osteopath = $default.Osteopath;
import Role = $default.Role;
import Session = $default.Session;
import Student = $default.Student;
